...
INSERT INTO evento (nome, descrizione, tipologia, data_evento, ora_inizio, ora_fine, ricorrenza, data_fine_ricorrenza, ID_corso, ID_responsabile, ID_aula) VALUES ("EsInformatica", "algoritmi", "ESAME", curdate(), CURTIME() + INTERVAL 2 HOUR, CURTIME() + INTERVAL 5 HOUR, "NESSUNA", null, 3, 3, 2);
